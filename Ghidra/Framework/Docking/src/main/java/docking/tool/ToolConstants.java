...
public interface ToolConstants extends DockingToolConstants {
	 ...
	 */
	String SHARED_OWNER = "Shared";

	/**
	 * Tool options name
	 */
	String TOOL_OPTIONS = "Tool";

	/**
	 * Graph options name
	 */
	String GRAPH_OPTIONS = "Graph";

	/**
	 * Name of the help topic for "About" domain objects and Ghidra
	 */
	String ABOUT_HELP_TOPIC = "About";

	/**
	 * Name of help topic for the front end (Ghidra Project Window)
	 */
	String FRONT_END_HELP_TOPIC = "FrontEndPlugin";

	/**
	 * Name of help topic for the Tool
	 */
	String TOOL_HELP_TOPIC = "Tool";

	/** Used for navigation-based action */
	String MENU_GROUP_NEXT_CODE_UNIT_NAV = "NextPrevCodeUnit";

	/**
	 * Primary toolbar group number 1, starting from the left
	 */
	String TOOLBAR_GROUP_ONE = "1_Toolbar_Navigation_Group";

	/**
	 * Primary toolbar group number 2, starting from the left
	 */
	String TOOLBAR_GROUP_TWO = "2_Toolbar_Navigation_Group";

	/**
	 * Primary toolbar group number 3, starting from the left
	 */
	String TOOLBAR_GROUP_THREE = "3_Toolbar_Navigation_Group";

	/**
	 * Primary toolbar group number 4, starting from the left
	 */
	String TOOLBAR_GROUP_FOUR = "4_Toolbar_Navigation_Group";
}

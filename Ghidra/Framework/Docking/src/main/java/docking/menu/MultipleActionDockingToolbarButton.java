...
public class MultipleActionDockingToolbarButton extends EmptyBorderButton {
	...
	/**
	 * By default a click on this button will trigger {@code actionPerformed()} to be called.
	 * You can call this method to disable that feature.  When called with {@code false}, this

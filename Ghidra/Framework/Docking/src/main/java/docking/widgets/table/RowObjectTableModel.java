...
public interface RowObjectTableModel<T> extends TableModel {
	 ...
	 * is a filtering model, that the given {@code t} may not have a row value for the current
	 ...
	 * <p>
	 * For those subclasses using an array, you may use the {@code Arrays} class to create

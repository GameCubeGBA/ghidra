 ...
 *  {@code startIndex} and <code>endindex</code>) with sub-positions within those rows (defined by
 *  {@code startField} and <code>endField</code>). As an example, consider a text select that begins on

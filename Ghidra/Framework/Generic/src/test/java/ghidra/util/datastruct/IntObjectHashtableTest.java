...
public class IntObjectHashtableTest extends AbstractGenericTest {

    /**
	 * Constructor
	 * @param arg0
	 */
	public IntObjectHashtableTest() {
    }
...
@Test
    public void testIntObjectHashtable() {
        ...
        testContains(ht, new int[]{10000,20000,30000,40000}, "Add");
        ...
        testContains(ht, new int[]{10000,30000,40000}, "Remove");
        ...
        testContains(ht,new int[]{}, "RemoveAll");
    ...
    public static void test(IntObjectHashtable<String> ht, int key, Object value) {

...
public class CascadedDropTarget extends DropTarget {
	 ...
	 * 
	 * If the given {@code dropTarget} is an immediate child of this CascadedDropTarget (CDT), then
	 * the other child is returned.  Otherwise, a reference to this CDT will be returned with the 
	 * given {@code dropTarget} having been removed from one of this CDT's children.  This method
	 * effectively removes the given {@code dropTarget} from the hierarchy and collapses the tree
	 * structure as needed.
	 *   

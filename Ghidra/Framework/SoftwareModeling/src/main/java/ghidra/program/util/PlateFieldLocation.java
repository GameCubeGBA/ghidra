...
/**
 * The {@code PlateFieldLocation} class contains specific location information
...
public class PlateFieldLocation extends CommentFieldLocation {
	 ...
	 *        than the {@code row} due to the fact that the PlateField has fictitious borders
	 ...
	 * the comment row that was clicked.  {@code -1} will be returned if the border of the

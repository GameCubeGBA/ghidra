...
public interface DataTypeArchive extends DataTypeManagerDomainObject {
    ...
    String DATA_TYPE_ARCHIVE_INFO       = "Data Type Archive Information";
    /** Name of data type archive settings property list */
    String DATA_TYPE_ARCHIVE_SETTINGS	= "Data Type Archive Settings";
     ...
     * the event
     */
    void setObjChanged(int type, Object affectedObj, Object oldValue, 
    						Object newValue);

...
public interface ProgramContext {
	 ...
	 */
	void setRegisterValue(Address start, Address end, RegisterValue value)
	 ...
	 * (e.g., instruction exists).
	 */
	void setValue(Register register, Address start, Address end, BigInteger value)
			throws ContextChangeException;
	 ...
	 */
	AddressRangeIterator getRegisterValueAddressRanges(Register register, Address start,
			Address end);

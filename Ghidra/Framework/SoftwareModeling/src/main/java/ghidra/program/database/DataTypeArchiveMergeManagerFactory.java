...
public class DataTypeArchiveMergeManagerFactory {
	...
	public static DomainObjectMergeManager getMergeManager(DomainObject resultsObj,
		...
		DataTypeArchiveMergeManagerFactory factory =
			PluggableServiceRegistry.getPluggableService(DataTypeArchiveMergeManagerFactory.class);

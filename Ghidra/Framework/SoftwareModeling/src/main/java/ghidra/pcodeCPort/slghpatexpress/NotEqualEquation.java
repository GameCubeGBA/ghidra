...
public class NotEqualEquation extends ValExpressEquation {
	...
	public NotEqualEquation( Location location, PatternValue l, PatternExpression r ) {
		super( location, l, r );
	}
...

	{
		...
		if ( count == 0 ) {
			throw new SleighError( "Notequal constraint is impossible to match", lhs.location );
		}
	}

...
public class LessEqualEquation extends ValExpressEquation {

	public LessEqualEquation( Location location, PatternValue l, PatternExpression r ) {
		super( location, l, r );
	}
    ...
    public void genPattern( VectorSTL<TokenPattern> ops ) {
		...
		if ( count == 0 ) {
			throw new SleighError( "Less than or equal constraint is impossible to match", lhs.location );
		}
	}

...
public class DisplayFilteredTreeAction extends DisplayFilteredAction {

	public DisplayFilteredTreeAction(PluginTool tool, String owner,
		...
		setHelpLocation(new HelpLocation(owner, "display_filtered_tree"));

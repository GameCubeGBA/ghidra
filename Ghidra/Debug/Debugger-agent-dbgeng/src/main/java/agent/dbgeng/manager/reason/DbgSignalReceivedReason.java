 ...
 */
public class DbgSignalReceivedReason implements DbgReason {
	private final String signalName;

	public DbgSignalReceivedReason(Map<String, Object> info) {
		this.signalName = (String) info.get("signal-name");
	}

...
public class VTableIDebugOutputCallbacksWide extends Structure {
	public static class ByReference extends VTableIDebugOutputCallbacksWide
	...
	@FunctionalInterface
    public interface OutputCallback extends StdCallLibrary.StdCallCallback {
		HRESULT invoke(Pointer thisPointer, ULONG Mask, WString Text);
	}
}

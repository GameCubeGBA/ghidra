...
public class VTableIDebugEventContextCallbacks extends Structure {
	public static class ByReference extends VTableIDebugEventContextCallbacks
	...
	public interface CreateProcessCallback extends StdCallLibrary.StdCallCallback {
		HRESULT invoke(Pointer thisPointer, ULONGLONG ImageFileHandle, ULONGLONG Handle,
				...
				ULONGLONG ThreadDataOffset, ULONGLONG StartOffset, Pointer Context,
				ULONG ContextSize);
	}

...
public class VoidPropertyMapDBTest extends AbstractGhidraHeadedIntegrationTest implements ErrorHandler {
	...
	private VoidPropertyMapDB propertyMap;
	...
	@Test
	public void testVoidPropertyMapDB() throws Exception {
	...
	public void testAdd() throws Exception {
		createPropertyMap("TEST");
		propertyMap.add(addr(100));
		Table propertyTable = db.getTable(propertyMap.getTableName());
		assertNotNull(propertyTable);
		propertyMap.add(addr(200));
		propertyMap.add(addr(300));
		propertyMap.add(addr(400));
		propertyMap.add(addr(500));

...
public final class XCoffFileHeaderFlags {
    ...
    public static final int F_FDPR_PROF    = 0x0010;
	/** file was reordered with fdpr command */
    public static final int F_FDPR_OPTI    = 0x0020;
	/** file uses Very Large Program Support */
    public static final int F_DSA          = 0x0040;
	 ...
	 */
    public static final int F_LOADONLY     = 0x4000;

...
public class ConvertToDoubleAction extends AbstractConvertAction {

	public ConvertToDoubleAction(EquatePlugin plugin) {
		super(plugin, "Convert To Double", false);
	}
	...
	protected String getMenuName(Program program, Scalar scalar, boolean isData) {
		...
		return getStandardLengthString("Double:") + valueString;
	}

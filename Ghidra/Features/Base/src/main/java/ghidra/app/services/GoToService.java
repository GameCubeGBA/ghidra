...
public interface GoToService {
	 ...
	 * {@code null} as the <code>program</code> parameter will cause this method to attempt to find
	 ...
	 * GoTo will not be performed and false will be returned.  Passing {@code null} as the
	 * {@code program} parameter will cause this method to attempt to find
	 * a program that contains the given ProgramLocation.
	 * 
	 * @param goToAddress the address to goto
	 * @param program the program within which to perform the GoTo

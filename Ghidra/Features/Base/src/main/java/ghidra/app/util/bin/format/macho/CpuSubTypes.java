...
public final class CpuSubTypes {
	...
	public static final int CPU_SUBTYPE_POWERPC_Max      = 10;//open source
	public static final int CPU_SUBTYPE_POWERPC_SCVger   = 11;//open source
	...
	public static final int CPU_SUBTYPE_486SX            = CPU_SUBTYPE_INTEL(4, 8);// 8 << 4 = 128
	...
	private static final int CPU_SUBTYPE_INTEL(int f, int m)	{
		return f + (m << 4);
	}
	...
	public static final int CPU_SUBTYPE_MIPS_R2000a   = 4;/* pmax */
	public static final int CPU_SUBTYPE_MIPS_R2000    = 5;
	public static final int CPU_SUBTYPE_MIPS_R3000a   = 6;/* 3max */
	...
	public static final int CPU_SUBTYPE_HPPA_7100       = 0; /* compat */
	...
	public static final int	CPU_SUBTYPE_ARM_V7F        = 10;//unused

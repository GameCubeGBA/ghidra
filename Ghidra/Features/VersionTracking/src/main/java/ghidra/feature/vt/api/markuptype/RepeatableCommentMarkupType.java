...
public class RepeatableCommentMarkupType extends CommentMarkupType {

//==================================================================================================
// Factory Methods
//==================================================================================================

	public static final VTMarkupType INSTANCE = new RepeatableCommentMarkupType();

//==================================================================================================
// End Factory Methods
//==================================================================================================

	private RepeatableCommentMarkupType() {
		super("Repeatable Comment");
	}
	...
	protected ProgramLocation getLocation(VTAssociation association, Address address,
		...
		return new FunctionRepeatableCommentFieldLocation(program, address, null, null, 0, 0);
	}

	@Override
	public VTMatchApplyChoices.CommentChoices getCommentChoice(ToolOptions options) {
        return options.getEnum(VTOptionDefines.REPEATABLE_COMMENT, CommentChoices.APPEND_TO_EXISTING);
	}

	@Override
	public VTMarkupItemApplyActionType getApplyAction(ToolOptions options) {
		VTMatchApplyChoices.CommentChoices commentChoice =
			options.getEnum(VTOptionDefines.REPEATABLE_COMMENT, CommentChoices.APPEND_TO_EXISTING);
	...
	public Options convertOptionsToForceApplyOfMarkupItem(VTMarkupItemApplyActionType applyAction,
		...
		switch (applyAction) {
			case ADD:
				options.setEnum(VTOptionDefines.REPEATABLE_COMMENT,

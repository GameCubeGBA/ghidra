...
public class LZ4ArchiveFileSystem extends GFileSystemBase {
	 ...
	 * LZ4 Magic Number
	 */
    public static final int ARCHIVE_MAGIC = 0x184C2102;
	public static final byte[] ARCHIVE_MAGIC_BYTES = { 0x02, 0x21, 0x4c, 0x18 };
	 ...
	 */
    public static final int LZ4_DEFAULT_UNCOMPRESSED_CHUNK_SIZE = (8 << 20);

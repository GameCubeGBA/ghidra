...
public class ISO9660VolumeDescriptor extends ISO9660BaseVolume {
	...
	public String toString() {
		...
		buff.append("Volume Space Size: 0x").append(Integer.toHexString(volumeSpaceSizeLE)).append("\n");
		buff.append("Unused: ").append(new String(unused3).trim()).append("\n");
		buff.append("Volume Set Size: 0x").append(Integer.toHexString(volumeSetSizeLE)).append("\n");
		buff.append("Volume Sequence Number: 0x").append(Integer.toHexString(volumeSeqNumberLE)).append("\n");
		buff.append("Logical Block Size: 0x").append(Integer.toHexString(logicalBlockSizeLE)).append("\n");
		buff.append("Path Table Size: 0x").append(Integer.toHexString(pathTableSizeLE)).append("\n");
		...
		buff.append("Calculated Location of Type-L Path Table: 0x").append(Integer.toHexString(typeLPathTableLocation * logicalBlockSizeLE)).append("\n");
		buff.append("Calculated Location of Type-M Path Table: 0x").append(Integer.toHexString(typeMPathTableLocation * logicalBlockSizeBE)).append("\n");

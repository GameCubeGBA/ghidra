...
/**
 * This class represents a MSFT <b>{@code __catchsym$}</b> (prefix) symbol.  We have created
 *  this object and the <b>{@code MDObjectReserved}</b> type from which it is derived.  We

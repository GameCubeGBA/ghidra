...
/**
 * This class represents a MSFT <b>{@code __unwindtable$}</b> (prefix) symbol.  We have
 ...
 *   __unwindtable$?test_eh1@@YAHXZ
 * </pre>
*/
public class MDObjectUnwindTable extends MDObjectReserved {
	MDObjectCPP objectCPP;

	public MDObjectUnwindTable(MDMang dmang) {
		super(dmang);
	}
	...
	public void insert(StringBuilder builder) {
		...
		dmang.appendString(builder, "[UnwindTable]{" + objectCPP + "}");
	}
